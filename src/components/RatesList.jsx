...
// Componente para mostrar la lista de monedas, con enlace a página de detalle para cada una
      ...
      {Object.entries(rates).map(([currency, value]) => (
        <li key={currency}>
          <Link
            ...
            className="block py-4 px-6 rounded-lg shadow-md border bg-white hover:bg-gray-200 transition"
          >
